import { Mail, Lock, Eye, CheckCircle, Shield, BarChart3, ArrowRight, Check } from "lucide-react";
...
export default function Signup() {
  return (
    <div className="flex min-h-screen w-full flex-col lg:flex-row">
      ...
      <div className="relative flex w-full flex-col gap-24 bg-black p-8 text-white lg:w-1/2 lg:p-16">
        {/* Background Image */}
        ...
        <div className="relative z-10 mt-8">
          ...
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-10 w-10 rounded-full border-2 border-black bg-gray-200 overflow-hidden">
                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${i}`} alt="Business" className="h-full w-full object-cover" />
                </div>
              ))}
            </div>
      ...
      <div className="flex w-full flex-col justify-center bg-[#F9FAFB] p-8 lg:w-1/2 lg:p-24">
        <div className="mx-auto w-full max-w-md">
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-blue-600 px-6 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-blue-700 focus:ring-4 focus:ring-blue-600/20 focus:outline-none"
            >
              Create Free Account
            </button>
          </form>
